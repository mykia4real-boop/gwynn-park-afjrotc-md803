(()=>{
  ...
  @media(min-width:1024px){
    body.guest-shell .public-header{position:sticky!important;top:0!important;left:0!important;right:0!important;width:100%!important;height:96px!important;min-height:96px!important;max-height:96px!important;display:grid!important;grid-template-columns:300px minmax(0,1fr) 106px!important;align-items:center!important;gap:24px!important;padding:0 28px!important;background:#082944!important;border:0!important;border-bottom:1px solid #284660!important;box-shadow:0 4px 14px rgba(0,0,0,.14)!important;overflow:visible!important;z-index:150!important;box-sizing:border-box!important}
    ...
    body.guest-shell .guest-fixed-nav{display:flex!important;align-items:center!important;justify-content:center!important;gap:8px!important;min-width:0!important;overflow:visible!important}
    body.guest-shell .guest-fixed-nav button{display:inline-flex!important;align-items:center!important;justify-content:center!important;min-height:52px!important;padding:10px 13px!important;border:0!important;border-radius:10px!important;background:transparent!important;color:#f0f4f8!important;font-size:14px!important;font-weight:800!important;line-height:1.15!important;white-space:nowrap!important;cursor:pointer!important}
    ...
    @media(max-width:1180px){
      body.guest-shell .public-header{grid-template-columns:250px minmax(0,1fr) 90px!important;gap:10px!important;padding:0 18px!important}
      body.guest-shell .public-brand{width:250px!important;min-width:250px!important;max-width:250px!important}
