(()=>{
  ...
  style.textContent=`
    /* v110 — signed-in users get the full professional panel; guests keep a clean top dashboard */
    body.account-shell{--account-panel-width:286px}

    @media(min-width:1024px){
      body.account-shell .public-header{
        width:var(--account-panel-width)!important;
        padding:24px 18px 20px!important;
        background:linear-gradient(180deg,#062642 0%,#0a3154 100%)!important;
        border-right:1px solid rgba(160,194,222,.24)!important;
        box-shadow:10px 0 30px rgba(0,0,0,.13)!important;
      }
      ...
      body.account-shell .public-brand .crest{
        width:58px!important;height:58px!important;min-width:58px!important;
        border:4px solid #ffd83d!important;border-radius:50%!important;
        color:#ffd83d!important;font-size:18px!important;
      }
      ...
      body.account-shell .public-nav button{
        min-height:52px!important;padding:13px 14px!important;border-radius:13px!important;
        font-size:15px!important;font-weight:800!important;color:#eaf2f8!important;
      }
      body.account-shell .public-nav button::before{margin-right:12px!important;font-size:20px!important}
      body.account-shell .public-nav button.active,
      body.account-shell .public-nav button:hover{background:#235d91!important;color:#fff!important}
      body.account-shell .public-header>.sign-in{
        min-height:48px!important;padding:11px 13px!important;border-radius:12px!important;
        font-size:13px!important;background:#ffd83d!important;color:#071528!important;border:0!important;
      }
      ...
      body.account-shell #publicSite,
      body.account-shell #publicFooter,
      body.account-shell .site-alert-banner{margin-left:var(--account-panel-width)!important}
      ...
      body.guest-shell .public-header{
        ...
        border:0!important;border-bottom:1px solid #29435f!important;
      ...
      body.guest-shell .public-header>.sign-in{width:auto!important;min-height:42px!important;margin:0!important;padding:10px 15px!important;border-radius:10px!important;font-size:13px!important;overflow:visible!important}
      body.guest-shell .public-header>.sign-in::before{display:none!important;content:none!important}
      body.guest-shell .site-rail-toggle{display:none!important}
      body.guest-shell #publicSite,
      body.guest-shell #publicFooter,
      body.guest-shell .site-alert-banner{margin-left:0!important}
    ...
    @media(max-width:1023px){
      ...
      body.guest-shell .site-rail-toggle{display:none!important}
      body.guest-shell .mobile-menu-btn{
        display:grid!important;place-items:center!important;width:42px!important;height:42px!important;
        flex:0 0 42px!important;border:0!important;border-radius:11px!important;
        background:#ffd83d!important;color:#073252!important;font-size:0!important;font-weight:900!important;padding:0!important;
      }
      body.guest-shell .mobile-menu-btn::before{content:'☰';font-size:20px!important;line-height:1!important}
      body.guest-shell .public-header>.sign-in{
        display:block!important;width:auto!important;min-height:40px!important;margin:0!important;padding:9px 11px!important;
        border-radius:10px!important;font-size:11px!important;overflow:visible!important;flex:0 0 auto!important;
      }
      body.guest-shell .public-header>.sign-in::before{display:none!important;content:none!important}
      body.guest-shell #mobileNav:not(.hidden){
        display:grid!important;position:fixed!important;left:0!important;right:0!important;top:78px!important;z-index:75!important;
        grid-template-columns:1fr 1fr!important;gap:8px!important;padding:14px!important;
        background:#082944!important;border-bottom:1px solid #29435f!important;box-shadow:0 12px 24px rgba(0,0,0,.18)!important;
      }
  ...
  function applyMode(session){
    ...
    if(signedIn){
      if(localStorage.getItem('afjrotcRailPreferenceSet')!=='1'){
  ...
  document.addEventListener('click',e=>{
    if(e.target.closest('.site-rail-toggle'))localStorage.setItem('afjrotcRailPreferenceSet','1');
  });
