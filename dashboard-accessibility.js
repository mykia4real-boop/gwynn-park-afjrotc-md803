(()=>{
  function addStyles(){
    ...
    style.textContent=`
      ...
      @media(max-width:720px){.cadet-dashboard-shell{display:block}.dashboard-panel-toggle{display:block}.dashboard-sidepanel{position:static;max-height:none;margin-bottom:12px;display:none}.dashboard-sidepanel.open{display:block}.dashboard-shortcuts{grid-template-columns:repeat(2,minmax(0,1fr));gap:7px}.dashboard-shortcut{border:1px solid #e2e8f0;background:#fff}.comment-form{grid-template-columns:1fr}.comment-form button{width:100%}}
      @media(max-width:440px){.dashboard-shortcuts{grid-template-columns:1fr}}
