(()=>{
  ...
  s.textContent=`
    @media(max-width:1023px){
      ...
      .public-header{position:fixed!important;inset:0 auto 0 0!important;width:var(--site-mobile-rail)!important;height:100vh!important;display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:0!important;padding:12px 8px!important;background:linear-gradient(180deg,#0b1b31,#0a2747)!important;border:0!important;border-right:1px solid #29435f!important;box-shadow:6px 0 22px rgba(15,23,42,.08)!important;overflow:visible!important;transition:width .22s ease!important;z-index:80!important}
      ...
      .public-nav{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:3px!important;width:100%!important;margin:10px 0 8px!important;max-height:calc(100vh - 150px)!important;overflow-y:auto!important;overflow-x:hidden!important;flex:1 1 auto!important}
      ...
      #publicSite{width:auto!important;min-width:0!important}
      ...
      .admin-side{position:fixed!important;inset:0 auto 0 0!important;width:var(--site-mobile-rail)!important;height:100vh!important;padding:12px 8px 74px!important;background:linear-gradient(180deg,#0b1b31,#0a2747)!important;border-right:1px solid #29435f!important;box-shadow:6px 0 22px rgba(15,23,42,.08)!important;overflow:visible!important;transition:width .22s ease!important;z-index:80!important}
      ...
      .admin-side nav{display:flex!important;flex-direction:column!important;gap:3px!important;margin-top:10px!important;max-height:calc(100vh - 150px)!important;overflow-y:auto!important;overflow-x:hidden!important}
      ...
      .admin-main{margin-left:var(--site-mobile-rail)!important;transition:margin-left .22s ease!important;min-width:0!important}
